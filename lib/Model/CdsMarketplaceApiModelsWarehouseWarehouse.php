<?php
/**
 * CdsMarketplaceApiModelsWarehouseWarehouse
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * CdsMarketplaceApiModelsWarehouseWarehouse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CdsMarketplaceApiModelsWarehouseWarehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cds.MarketplaceApi.Models.Warehouse.Warehouse';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'seller_id' => 'int',
        'address' => '\OpenAPI\Client\Model\CdsMarketplaceApiModelsWarehouseWarehouseAddress',
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\CdsMarketplaceApiModelsWarehouseWarehouseAddress|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\CdsMarketplaceApiModelsWarehouseWarehouseAddress|null $address address
     *
     * @return self
     */
